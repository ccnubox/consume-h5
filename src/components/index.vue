                        ...
                        <div class = "pieBox">
                           <div class="piePic">
                            <svg width="100" height="100" class="pie">
                                <circle r="50" cx="50" cy="50" class="circle1" :style="circle1"> </circle>
                                <circle r="50" cx="50" cy="50" class="circle2" :style="circle2"> </circle>
                            </svg>
                        </div>
                        <div class="dataBox">
                            <div class="data">
...
export default {
    data() {
        ...
        computed: {
            circle1: function () {
                return {
                    strokeDasharray: this.circlel1 * 345.4 + ' 345.4'
                }
            },
            circle2: function () {
                return {
                    strokeDashoffset: '-' + this.circlel1 * 345.4,
                    strokeDasharray: this.circlel2 * 345.4 + ' 345.4'
                }
            }
        }
}
